...
public class BaseTest {
	...
	public static final String app_url = "http://claroline:80/claroline11110/claroline/index.php";
	...
	public void setUp(){
		...
		chromeOptions.addArguments("--no-sandbox", "--disable-gpu", "--start-maximized");
